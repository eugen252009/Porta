...
export type KernelCommand = { type: "CreateSession"; sessionId?: string; target?: string; model?: ModelSelection } | { type: "SubmitInput"; sessionId: string; input: string } | { type: "CancelExecution"; sessionId: string } | { type: "CloseSession"; sessionId: string } | { type: "ResolveApproval"; approvalId: string; decision: ApprovalCommandDecision; reason?: string };
