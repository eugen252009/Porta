...
export type KernelCommand = { type: "CreateSession" } | { type: "SubmitInput"; sessionId: string; input: string } | { type: "CancelExecution"; sessionId: string } | { type: "CloseSession"; sessionId: string } | { type: "ResolveApproval"; approvalId: string; decision: ApprovalCommandDecision; reason?: string };
