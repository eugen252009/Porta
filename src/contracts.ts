...
export interface ExecutionRequest { schemaVersion: 1; language?: ExecutionLanguage; source?: string; args?: readonly string[]; stdin?: string; workingDirectory?: string; environment?: Record<string, string>; timeoutMs?: number; policy: ExecutionPolicy }
export const executionRequestSchema = z.object({ schemaVersion, language: z.enum(["javascript", "typescript"]).optional(), source: z.string().optional(), args: z.array(z.string()).optional(), stdin: z.string().optional(), workingDirectory: z.string().optional(), environment: z.record(z.string()).optional(), timeoutMs: z.number().int().positive().optional(), policy: executionPolicySchema });
