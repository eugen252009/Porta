...
export interface DelegatedTaskRequest { readonly version: 1; readonly type: "porta-delegated-task"; readonly delegationId: string; readonly objective: string; readonly constraints?: readonly string[]; readonly acceptanceCriteria?: readonly string[]; readonly requestedModel?: string; readonly permissions?: readonly string[]; readonly budget?: { readonly maxTurns?: number; readonly maxToolCalls?: number } }
